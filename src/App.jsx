...
const TIMELINE = [
  ...
  { year: "2026", title: "Infrastructure connectée", subtitle: "Réseau inter-serveurs", desc: "J’ai transformé des serveurs Discord indépendants en une véritable infrastructure connectée. Les messages, les données et les systèmes ne sont plus isolés, mais circulent en temps réel entre plusieurs communautés. Chaque serveur devient un nœud d’un réseau global, capable d’interagir avec les autres comme une seule et même entité. Synchronisation des événements, partage d’informations, communication inter-serveurs… J’ai dépassé les limites classiques de Discord pour créer un écosystème unifié, dynamique et évolutif.", color: "#07877A", icon: "🌍", detail: "Réseau global • Inter-serveurs • Système unifié"},
];
